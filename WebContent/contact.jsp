...
<title>Online Voting App-Contact</title>
...
<body>
	<div class="main">
        ...
        <div class="menu">
                	<table class="Itable">
                		<tr>
                			...
                			<td><a class="menu" href="#">Contact Us</a></td>
        ...
        <div class="middle">
            <div class="midHeading"><br>
                <h2>Contact Us</h2>
            </div>
            
            <div class="image">
            	<img class="pnc" src="pnc.jpg">
            </div>
            
            <div class="pageContent">
            	<ul>
            		<li>Name:- Praveen Sanpada</li>
            		<li>Contact No.:- 7225854655</li>
            		<li>E-Mail:- Praveensanpada@gmail.com</li>
            		<li>Course:- B.Tech</li>
            		<li>College:- Poornima University</li>
